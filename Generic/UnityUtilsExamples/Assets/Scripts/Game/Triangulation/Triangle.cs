...
namespace ceometric.DelaunayTriangulator
{
    ...
    public class Triangle
    {
        ...
        public Vector3 getCenter()
        {
            ...
            Vector3 ac = new Vector3((float)(Vertex3.X - Vertex1.X), (float)(Vertex3.Y - Vertex1.Y), (float)(Vertex3.Z - Vertex1.Z));
            Vector3 ab = new Vector3((float)(Vertex2.X - Vertex1.X), (float)(Vertex2.Y - Vertex1.Y), (float)(Vertex2.Z - Vertex1.Z)) ;
            ...
            Vector3 ccs = new Vector3((float)Vertex1.X, (float)Vertex1.Y, (float)Vertex1.Z) + toCircumsphereCenter; // now this is the actual 3space location
            return ccs;
        }
    }
}
